...
1. Ajouter `KDECOLE_TOKEN=<VOTRE_TOKEN>` dans le fichier .env en remplaçant VOTRE_TOKEN par votre jeton d'authentification K-D'Ecole pour l'obtenir -> [cliquer ici](https://github.com/Syycorax/kdecole-docker-grafana/wiki/Obtenir-le-jeton-KDECOLE)
